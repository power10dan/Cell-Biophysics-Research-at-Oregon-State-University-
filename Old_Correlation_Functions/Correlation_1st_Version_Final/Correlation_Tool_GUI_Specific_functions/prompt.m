...
%   folder in which the user wants to save his or her files. Code is based
%   on this Matlab documentation: http://www.mathworks.com/help/matlab/ref/inputdlg.html
%
% Fields:None
%
%   
...
% prompts the user for a folder name 
    ...
    dlg_title = 'Input';
    num_lines = 1;
    answer_temp = inputdlg(prompt,dlg_title,num_lines); % store into temp variable for checking purposes
