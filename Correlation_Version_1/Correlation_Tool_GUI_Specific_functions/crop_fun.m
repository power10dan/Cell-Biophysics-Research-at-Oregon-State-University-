% function crop_fun(src, evnt,image,handles)
%
% Description:
%
%    This function crops the image to the user's specified dimensions and
%    output the cropped image onto the GUI.
%
% Fields:
...
function crop_fun(src, evnt,image,handles)
    ...
    axes(handles.axes1);
    im = imagesc(new_image);
    set(im, 'ButtonDownFcn',{@crop_fun,image,handles}); % Takes in three parameters
end